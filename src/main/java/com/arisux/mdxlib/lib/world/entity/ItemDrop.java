...
public class ItemDrop
{
     ...
     * 
     * @param rate - The rate at which this item will drop. Entering 5 will result in the ItemStack dropping 5% of the time.
     * @param dropType - The type of drop this is. See {@link com.arisux.mdxlib.lib.world.entity.ItemDrop.DropType} for a list of types.
     * @param stacks - The ItemStack instance this drop will consist of.
     */
    ...
    /**
     * Try to drop this ItemDrop, but using a different drop type. See {@link com.arisux.mdxlib.lib.world.entity.ItemDrop.DropType} for a list of types.
     * 
     * @param entity - The entity dropping this ItemDrop.
    ...
    /**
     * Try to drop this ItemDrop, but set a different drop type. See {@link com.arisux.mdxlib.lib.world.entity.ItemDrop.DropType} for a list of types.
     * 
     * @param entity - The entity dropping this ItemDrop.
     * @param rate - The overridden drop rate. A drop rate of 0 will use the predefined drop rate.
     * @param type - The modified drop type.
    ...
    /**
     * @return The type of drop this is. See {@link com.arisux.mdxlib.lib.world.entity.ItemDrop.DropType} for a list of types.
     */

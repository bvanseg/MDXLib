...
public class Screen
{
     ...
     */
    public static com.arisux.mdxlib.lib.client.render.ScaledResolution scaledDisplayResolution()
    {
        return new com.arisux.mdxlib.lib.client.render.ScaledResolution(Game.minecraft(), Game.minecraft().displayWidth, Game.minecraft().displayHeight);
    }

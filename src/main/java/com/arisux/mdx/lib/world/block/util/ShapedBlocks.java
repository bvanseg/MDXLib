package com.arisux.mdx.lib.world.block.util;

import java.util.ArrayList;
import java.util.Arrays;

import com.arisux.mdx.lib.game.Game;
import com.arisux.mdx.lib.world.block.BlockShape;
...
public class ShapedBlocks
{
    ...
    public static void register(String modid, String identifier, Block[] blocks)
    {
        for (Block block : new ArrayList<Block>(Arrays.asList(blocks)))
        {
            ...
            Game.register(modid, identifier, block);
        }
    }

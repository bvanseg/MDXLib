...
public class Screen
{
     ...
     */
    public static com.arisux.mdx.lib.client.util.ScaledResolution scaledDisplayResolution()
    {
        return new com.arisux.mdx.lib.client.util.ScaledResolution(Game.minecraft(), Game.minecraft().displayWidth, Game.minecraft().displayHeight);
    }

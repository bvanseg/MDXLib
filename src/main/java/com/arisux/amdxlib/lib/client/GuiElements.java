...
import com.arisux.amdxlib.lib.game.IAction;
...
public class GuiElements
{
    ...
    public static class GuiCustomButton extends GuiButton implements IGuiElement
    {
        ...
        {
            this.drawButton(Game.minecraft(), (int) (RenderUtil.scaledMousePosition().x * scale), (int) (RenderUtil.scaledMousePosition().y * scale));
        }

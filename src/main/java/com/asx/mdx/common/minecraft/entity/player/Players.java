package com.asx.mdx.common.minecraft.entity.player;
...
public class Players
{
    ...
    {
        String retrieved = Networks.query(String.format("http://aliensvspredator.org/login/api.mojang.php?function=uuid&user=%s", username));

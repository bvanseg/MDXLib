...
public class Entities
{
    ...
    {
        ArrayList<Pos> potentialLocations = com.asx.mdx.lib.world.block.Blocks.getCoordDataInRangeIncluding((int) around.x, (int) around.y, (int) around.z, 2, toCheck.world, Blocks.AIR);
